...
export default function AnnualReportsPage() {
    return (
        <PageContainer
            ...
            action={<Button>Download Latest Annual Report</Button>}
        >
            <div className="space-y-6">
                <Card className="border-border/60">
                    <CardHeader>
                        <CardTitle>Portfolio Growth Context</CardTitle>
                        <CardDescription>Use the archive alongside growth data to see how donor support scaled over time.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <GrowthLineChart
                            data={programGrowth}
