...
import { applicationSteps, mockApplication } from "@/mock-data/applicant";
...
const essayPrompts = [
    {
        ...
        wordMin: 300,
        wordMax: 500,
        defaultValue: mockApplication.essays?.whyApply ?? "",
    },
    {
        ...
        <PageContainer title="Step 3: Essays" description="Four structured essay responses are required. Answer each question with honesty and precision.">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800">
                    ...
                    <p>
                        Do not copy content from the internet or use AI-generated text. Your essays will be assessed for originality, clarity, and genuine personal voice. Plagiarism is grounds for immediate disqualification.
                    </p>
                </div>

                {essayPrompts.map((essay, i) => {
                    const count = wordCount(essay.defaultValue);
                        ...
                        <Card key={essay.id} className="border-border/50">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {isStarted ? (
                                                ...
                                                <Badge variant="outline" className="text-[10px] h-4 text-muted-foreground">Not started</Badge>
                                            )}
                                        </div>
                            ...
                            <CardContent className="p-5 space-y-3">
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        id={essay.id}
                                        defaultValue={essay.defaultValue}
                                ...
                                <div className="flex justify-between text-xs text-muted-foreground">
                                    <span className="flex items-center gap-1.5">
                                        <Info className="h-3 w-3" /> Auto-saved as you type
                                    </span>
                ...
                <Card className="border-border/50">
                    <CardFooter className="flex justify-between p-5">
                        <div className="flex gap-2">
                            ...
                            <Button variant="ghost" className="gap-2"><Save className="h-4 w-4" /> Save Draft</Button>
                        </div>
