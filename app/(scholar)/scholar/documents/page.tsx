            ...
            <div className="space-y-6">
                <Card className="border-border/60">
                    <CardHeader>
                        ...
                        <CardDescription>Verification status, ownership, and expiry tracking for all uploaded records.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
                            ...
                            <TableBody>
                                {scholarDocuments.map((document) => (
                                    <TableRow key={document.id}>
                                        ...
                                        <TableCell>
                                            <Badge className={documentStatusClasses[document.status]}>
                                                {document.status}
                                            </Badge>
                                        </TableCell>
                                    </TableRow>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>What needs attention to keep your scholar record healthy.</CardDescription>
                        </CardHeader>
                    ...
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>Core records typically reviewed before placement matching.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            {[
