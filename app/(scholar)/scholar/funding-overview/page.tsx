        ...
        >
            <div className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <MetricCard title="Approved Support" value={fundingSnapshot.approved} description="Full scholarship commitment" icon={Landmark} />
                    <MetricCard title="Disbursed" value={fundingSnapshot.disbursed} description="Released to date" icon={Banknote} />
                    <MetricCard title="Next Stipend" value="₦350,000" description={fundingSnapshot.nextStipend} icon={Wallet} />
                    <MetricCard title="Emergency Fund" value={fundingSnapshot.emergencySupport} description="Available on verified need" icon={Briefcase} />
                </div>
                ...
                <div className="grid gap-6 xl:grid-cols-[1fr_1fr]">
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>How approved support is allocated across the scholar experience.</CardDescription>
                        </CardHeader>
                                ...
                                <div key={line.label} className="space-y-2">
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-xs text-muted-foreground">of {line.allocated}</p>
                                        </div>
                                    </div>
                    ...
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>Compliance and release signals for the current cycle.</CardDescription>
                        </CardHeader>
                ...
                <Card className="border-border/60">
                    <CardHeader>
                        ...
                        <CardDescription>Chronological record of approved funding support.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
