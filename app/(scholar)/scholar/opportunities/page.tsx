            ...
            <div className="space-y-6">
                    ...
                    <CardContent className="p-6">
                        <div className="grid gap-4 lg:grid-cols-3">
                            <div className="rounded-xl border bg-background/80 p-4">
                                ...
                                <p className="mt-3 font-semibold">{scholarProfile.placementTrack}</p>
                            </div>
                            <div className="rounded-xl border bg-background/80 p-4">
                                <p className="text-xs uppercase tracking-[0.24em] text-muted-foreground">Readiness score</p>
                                <p className="mt-3 text-3xl font-bold">78%</p>
                                <p className="mt-1 text-sm text-muted-foreground">Interview prep underway</p>
                            </div>
                            <div className="rounded-xl border bg-background/80 p-4">
                                <p className="text-xs uppercase tracking-[0.24em] text-muted-foreground">Active matches</p>
                                <p className="mt-3 text-3xl font-bold">3</p>
                                <p className="mt-1 text-sm text-muted-foreground">Across public analytics and health-tech</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>Current step-by-step path toward industry placement.</CardDescription>
                        </CardHeader>
                            ...
                            {placementStages.map((stage, index) => (
                                <div key={stage.label} className="flex gap-3">
                                    <div className="mt-1 flex flex-col items-center">
                                        ...
                                        {index < placementStages.length - 1 && <div className="mt-2 h-12 w-px bg-border" />}
                                    </div>
                                    <div className="pb-5">
                    ...
                    <Card className="border-border/60">
                        <CardHeader>
                            ...
                            <CardDescription>Open roles and programmes currently matched to your profile.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            {opportunities.map((opportunity) => (
                                <div key={opportunity.id} className="rounded-xl border bg-background p-4">
                                    <div className="flex flex-wrap items-start justify-between gap-3">
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-muted-foreground">{opportunity.organisation} · {opportunity.location}</p>
                                        </div>
                                    ...
                                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                                        <div className="rounded-lg bg-muted/20 p-3">
                                            ...
                                            <p className="mt-2 font-medium text-foreground">{opportunity.deadline}</p>
                                        </div>
                                        <div className="rounded-lg bg-muted/20 p-3">
                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Fit</p>
                                            <p className="mt-2 font-medium text-foreground">{opportunity.fit}</p>
                                        </div>
                                        <div className="rounded-lg bg-muted/20 p-3">
                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Readiness</p>
                                            <Progress value={opportunity.status === "active" ? 78 : opportunity.status === "completed" ? 100 : 56} className="mt-3 h-2" />
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <Card className="border-border/60">
                    <CardHeader>
                        ...
                        <CardDescription>What the current opportunity mix is building toward.</CardDescription>
                    </CardHeader>
