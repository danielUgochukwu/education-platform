...
export function Sidebar({ role = "applicant" }: SidebarProps) {
    ...
    const roleLinks = {
        ...
        scholar: [
            ...
            { href: "/scholar/academic-journey", icon: GraduationCap, label: "Academic Journey" },
            { href: "/scholar/milestones", icon: Flag, label: "Milestones" },
            { href: "/scholar/progress-reports", icon: ClipboardList, label: "Progress Reports" },
            { href: "/scholar/mentor-feedback", icon: MessageSquare, label: "Mentor Feedback" },
            { href: "/scholar/funding-overview", icon: Banknote, label: "Funding Overview" },
            { href: "/scholar/opportunities", icon: Briefcase, label: "Opportunities" },
        ...
        admin: [
            ...
            { href: "/admin/funding", icon: Banknote, label: "Funding Distribution" },
            { href: "/settings", icon: Settings, label: "Settings" },
        ],
    } as const;
